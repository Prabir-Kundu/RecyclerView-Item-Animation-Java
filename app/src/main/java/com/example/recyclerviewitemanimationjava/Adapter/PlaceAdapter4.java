...
public class PlaceAdapter4 extends RecyclerView.Adapter<PlaceAdapter4.MyViewHolder>{
    Context context;
    ArrayList<Place> placeList;

    public PlaceAdapter4(Context context, ArrayList<Place> placeList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.mainCardView.startAnimation(AnimationUtils.loadAnimation(holder.mainCardView.getContext(), R.anim.scale_up));
    }
