...
public class PlaceAdapter5 extends RecyclerView.Adapter<PlaceAdapter5.MyViewHolder>{
    Context context;
    ArrayList<Place> placeList;

    public PlaceAdapter5(Context context, ArrayList<Place> placeList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.mainCardView.startAnimation(AnimationUtils.loadAnimation(holder.mainCardView.getContext(), R.anim.slide_in_right));
    }
