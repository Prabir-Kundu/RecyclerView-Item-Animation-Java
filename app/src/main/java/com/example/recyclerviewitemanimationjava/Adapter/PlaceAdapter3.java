...
public class PlaceAdapter3 extends RecyclerView.Adapter<PlaceAdapter3.MyViewHolder>{
    Context context;
    ArrayList<Place> placeList;

    public PlaceAdapter3(Context context, ArrayList<Place> placeList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.mainCardView.startAnimation(AnimationUtils.loadAnimation(holder.mainCardView.getContext(), R.anim.rotate_in));
    }
