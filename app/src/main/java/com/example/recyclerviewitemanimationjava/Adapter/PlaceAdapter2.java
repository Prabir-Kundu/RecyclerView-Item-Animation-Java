...
public class PlaceAdapter2 extends RecyclerView.Adapter<PlaceAdapter2.MyViewHolder>{

    Context context;
    ArrayList<Place> placeList;

    public PlaceAdapter2(Context context, ArrayList<Place> placeList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.mainCardView.startAnimation(AnimationUtils.loadAnimation(holder.mainCardView.getContext(), R.anim.fall_down));
    }
